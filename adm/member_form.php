...
<form name="fmember" id="fmember" action="./member_form_update.php" onsubmit="return fmember_submit(this);" method="post" enctype="multipart/form-data">
    ...
    <ul class="formList">
        <li class="half">
            <div class="label">
                아이디 <sapn class="red">*</span>
            </div>
            <div class="iptBox">
                <input type="text" name="mb_id" value="<?php echo $mb['mb_id'] ?>" id="mb_id" <?php echo $required_mb_id ?> class="ipt" size="15" maxlength="20">
            </div>
        </li>
        <li class="half">
            <div class="label">
            ...
            <div class="iptBox">
                <input type="password" name="mb_password" id="mb_password" <?php echo $required_mb_password ?> class="ipt" size="15" maxlength="20">
            </div>
        </li>
        <li class="half">
            <div class="label">
                이름(실명) <span class="red">*</span>
            </div>
            <div class="iptBox">
                <input type="text" name="mb_name" value="<?php echo $mb['mb_name'] ?>" id="mb_name" required class="ipt" size="15" maxlength="20">
            </div>
        </li>
        <li class="half">
            <div class="label">
                닉네임 <span class="red">*</span>
            </div>
            <div class="iptBox">
                <input type="text" name="mb_nick" value="<?php echo $mb['mb_nick'] ?>" id="mb_nick" required class="ipt" size="15" maxlength="20">
            </div>
        </li>
        <li class="half">
            <div class="label">
                회원권한 <span class="red">*</span>
            </div>
            <div class="iptBox">
        ...
        <li class="half">
            ...
            <div class="iptBox">
                <input type="text" name="mb_email" value="<?php echo $mb['mb_email'] ?>" id="mb_email" maxlength="100" required class="ipt" size="30">
            </div>
        </li>
        <li class="half">
            <div class="label">
            ...
            <div class="iptBox">
                <input type="text" name="mb_homepage" value="<?php echo $mb['mb_homepage'] ?>" id="mb_homepage" class="ipt" maxlength="255" size="15">
            </div>
        </li>
        <li class="half">
            <div class="label">
            ...
            <div class="iptBox">
                <input type="text" name="mb_hp" value="<?php echo $mb['mb_hp'] ?>" id="mb_hp" class="ipt" size="15" maxlength="20">
            </div>
        </li>
        <li class="half">
            <div class="label">
            ...
            <div class="iptBox">
                <input type="text" name="mb_tel" value="<?php echo $mb['mb_tel'] ?>" id="mb_tel" class="ipt" size="15" maxlength="20">
            </div>
        </li>
        <li class="half">
            <div class="label">
        ...
        <li class="half">
         ...
         <li class="">
            ...
            <div class="iptBox address">
                <div class="add1">
                    <label for="mb_zip">우편번호</label>
                    <input type="text" name="mb_zip" value="<?php echo $mb['mb_zip1'] . $mb['mb_zip2']; ?>" id="mb_zip" class="ipt" size="5" maxlength="6">
                    <button type="button" class="btn_frmline add-btn" onclick="win_zip('fmember', 'mb_zip', 'mb_addr1', 'mb_addr2', 'mb_addr3', 'mb_addr_jibeon');">주소 검색</button>
                </div>
                <div class="add2">
                    <label for="mb_addr1">기본주소</label>
                    <input type="text" name="mb_addr1" value="<?php echo $mb['mb_addr1'] ?>" id="mb_addr1" class="ipt" size="60">
                </div>
                <div class="add2">
                    <label for="mb_addr2">상세주소</label>
                    <input type="text" name="mb_addr2" value="<?php echo $mb['mb_addr2'] ?>" id="mb_addr2" class="ipt" size="60">
                </div>
                <div class="add2">
                    <label for="mb_addr3">참고항목</label>
                    <input type="text" name="mb_addr3" value="<?php echo $mb['mb_addr3'] ?>" id="mb_addr3" class="ipt" size="60">
        ...
        <!-- <li>
            ...
            <div class="iptBox">
                <div class="notice">✅ 이미지 크기는 넓이 <?=$config['cf_member_icon_width'];?> 픽셀 높이 <?=$config['cf_member_icon_height'];?> 픽셀로 해주세요.</div>
                <input type="file" name="mb_icon" id="mb_icon" class="ipt">
                <?php
         ...
         <!-- <li>
            ...
            <div class="iptBox">
                <div class="notice">✅ 이미지 크기는 넓이 <?=$config['cf_member_img_width'];?> 픽셀 높이 <?=$config['cf_member_img_height'];?> 픽셀로 해주세요.</div>
                <input type="file" name="mb_icon" id="mb_icon" class="ipt">
                <?php
                $mb_dir = substr($mb['mb_id'], 0, 2);
                $icon_file = G5_DATA_PATH . '/member/' . $mb_dir . '/' . get_mb_icon_name($mb['mb_id']) . '.gif';
        ...
        <!-- <li>
            ...
            <div class="iptBox">
                <textarea name="mb_signature" id="mb_signature" class="ipt"><?php echo $mb['mb_signature'] ?></textarea>
            </div>
        </li>
        <li>
            <div class="label">
        ...
        <?php if ($config['cf_use_recommend']) { // 추천인 사용 ?>
            <li>
                ...
                <div class="iptBox flex"><?php echo ($mb['mb_recommend'] ? get_text($mb['mb_recommend']) : '없음'); // 081022 : CSRF 보안 결함으로 인한 코드 수정 ?></div>
            </li>
        <?php } ?>
        ...
        <?php
         ...
         <?php for ($i = 1; $i <= 10; $i++) { ?>
            <!-- <li class="half">
                ...
                <div class="iptBox flex">
                    <input type="text" name="mb_<?php echo $i ?>" value="<?php echo $mb['mb_' . $i] ?>" id="mb_<?php echo $i ?>" class="ipt" size="30" maxlength="255">
                </div>
            </li> -->
        <?php } ?>
    </ul>
    ...
    <div class="adm-btn-div">
      <a href="./member_list.php?<?php echo $qstr ?>" class="adm-btn" accesskey="s">목록</a>
